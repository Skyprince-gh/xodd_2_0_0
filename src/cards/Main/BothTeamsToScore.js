...
import Create from '../Create/BothTeamsToScore'
      ...
      { !eventsWindowIsActive &&
        <div className={oddsWindowStyle} id={newCard.id} onClick={(e) => toggleEditCardWindow(newCard.id)}>
          <div className={style.grp}>
            <h3>Teams</h3>
            <p>{newCard.stats.general.home} v {newCard.stats.general.away}</p>
          </div>
          ...
          <div className={style.grp}>
            <h3>Prediction</h3>
            <p>{newCard.both_teams_to_score.prediction}</p>
          </div>

          <div className={style.grp}>
            <h3>Percentage</h3>
            <p>{newCard.both_teams_to_score.percentage}%</p>
          </div>
          ...
          <div className={style.grp + " " + style.odds_grp}>
            ...
            <div className={style.odds}>
              <div className={style.odd}>
                <h4>Yes</h4>
                <p>{newCard.both_teams_to_score.odds.yes}</p>
              </div>
              <div className={style.odd}>
                <h4>No</h4>
                <p>{newCard.both_teams_to_score.odds.no}</p>
              </div>
            </div>
          </div>
          ...
          <div className={style.grp_scores}>
            ...
            {newCard.both_teams_to_score.isWon && <div className={style.validation_green}></div>}

            {!newCard.both_teams_to_score.isWon && <div className={style.validation_red}></div>}
          </div>
        </div>
      }
