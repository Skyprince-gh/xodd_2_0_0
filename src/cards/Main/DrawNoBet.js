...
import Create from '../Create/DrawNoBet'
    ...
    <div>
      { !eventsWindowIsActive &&
        <div className={oddsWindowStyle} id={newCard.id} onClick={(e) => toggleEditCardWindow(newCard.id)}>
          ...
          <div className={style.grp}>
            <h3>Prediction</h3>
            <p>{data.draw_no_bet.prediction}</p>
          </div>

          <div className={style.grp}>
            <h3>Percentage</h3>
            <p>{data.draw_no_bet.percentage}%</p>
          </div>
          ...
          <div className={style.grp + " " + style.odds_grp}>
            ...
            <div className={style.odds}>
              <div className={style.odd}>
                <h4>Home</h4>
                <p>{data.draw_no_bet.odds.home}</p>
              </div>

              <div className={style.odd}>
                <h4>Away</h4>
                <p>{data.draw_no_bet.odds.away}</p>
              </div>
            </div>
          </div>
          ...
          <div className={style.grp_scores}>
            ...
            {data.draw_no_bet.isWon && <div className={style.validation_green}></div>}

            {!data.draw_no_bet.isWon && <div className={style.validation_red}></div>}
          </div>
        </div>
      }
